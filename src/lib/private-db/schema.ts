...
export const checkoutOrders = pgTable(
  "checkout_orders",
  {
    ...
    productConfirmationEmailSentAt: timestamp("product_confirmation_email_sent_at", { withTimezone: true }),
    productConfirmationEmailClaimedUntil: timestamp("product_confirmation_email_claimed_until", { withTimezone: true }),
    productConfirmationEmailLastError: text("product_confirmation_email_last_error"),
...
export const trainingEnrollments = pgTable(
  "training_enrollments",
  {
    ...
    studentPaymentEmailSentAt: timestamp("student_payment_email_sent_at", { withTimezone: true }),
    trainingEmailClaimedUntil: timestamp("training_email_claimed_until", { withTimezone: true }),
...
export const appointmentHolds = pgTable(
  "appointment_holds",
  {
    ...
    bookingConfirmationEmailSentAt: timestamp("booking_confirmation_email_sent_at", { withTimezone: true }),
    bookingConfirmationEmailClaimedUntil: timestamp("booking_confirmation_email_claimed_until", { withTimezone: true }),
    bookingConfirmationEmailLastError: text("booking_confirmation_email_last_error"),
