...
function TrainingContactForm({
  ...
  return (
    <div className="h-full overflow-hidden rounded-[28px] border border-lh-line bg-lh-white shadow-[0_24px_70px_rgba(28,19,24,0.08)]">
      <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)]">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col justify-center p-8 md:p-10 lg:p-12">
