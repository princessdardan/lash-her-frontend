...
function wheel(element, { axis = "y", onWheel, onSwipe, swipeThreshold = 100, swipeTimeout = 150 }) {
    let state = "IDLE";
    /**
            ...
            case "SWIPING":
                {
                    ...
                    if (lastDelta > 0) {
                        if (deltaAbs < lastDelta) isDecelerating = true;
                        if (isDecelerating && deltaAbs > lastDelta) {
                            accelerationCount++;
...
//# sourceMappingURL=_41a4a76c._.js.map