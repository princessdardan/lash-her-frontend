...
const useHeaderContext = ()=>{
    ...
    if ($[0] !== "f102775bc5df783bb5f12889c6f194a03e64cf17452e90cc684fb91ec50c3aa0") {
        for(let $i = 0; $i < 1; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "f102775bc5df783bb5f12889c6f194a03e64cf17452e90cc684fb91ec50c3aa0";
    }
...
function HeaderWrapper(t0) {
    ...
    let t1;
    let t2;
    if ($[1] !== isGalleryPage || $[2] !== lastScrollY) {
        t1 = ({
    ...
    const t4 = isGalleryPage ? "fixed top-0" : "fixed md:sticky top-0";
    const t5 = isActive ? "bg-brand-pink" : "bg-black";
    const t6 = !isVisible && (isGalleryPage ? "-translate-y-full" : "md:translate-y-0 -translate-y-full");
    let t7;
    if ($[7] !== t4 || $[8] !== t5 || $[9] !== t6) {
        t7 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("z-50 w-full flex flex-col items-center px-4 py-4 shadow-md transition-all duration-300", t4, t5, t6);
        $[7] = t4;
        $[8] = t5;
        $[9] = t6;
        $[10] = t7;
    ...
    let t11;
    if ($[16] !== t10 || $[17] !== t3) {
        t11 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(HeaderContext.Provider, {
            value: t3,
            children: t10
        }, void 0, false, {
            fileName: "[project]/frontend/src/components/custom/layouts/header-wrapper.tsx",
...
_s1(HeaderWrapper, "E5pMcfOILKqavf3B4CITs17wSl0=", false, function() {
    return [
...
function MobileNavigation(t0) {
    ...
    if ($[0] !== "fc469ee65fbca814d0858cf983a28a7bad1c9a808fdc808a1971b7228dfa8f9e") {
        for(let $i = 0; $i < 24; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "fc469ee65fbca814d0858cf983a28a7bad1c9a808fdc808a1971b7228dfa8f9e";
    }
    const { ctaButton } = t0;
    const pathname = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"])();
    const { isActive: isHeaderActive } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$components$2f$custom$2f$layouts$2f$header$2d$wrapper$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useHeaderContext"])();
    ...
    const t1 = isHeaderActive ? "text-brand-red hover:bg-brand-red/10" : "text-brand-pink hover:bg-brand-pink/10";
    let t2;
    if ($[1] !== t1) {
        t2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("p-2 rounded-md transition-colors", t1);
        $[1] = t1;
        $[2] = t2;
    } else {
        t2 = $[2];
    ...
    let t7;
    if ($[9] !== t6) {
        t7 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
...
function HeaderButton(t0) {
    ...
    if ($[0] !== "c961c3f251af2cfc3ccd4b73bdfdd33ba61e42fa240a4fe08e7ce9ecee65bd83") {
        for(let $i = 0; $i < 7; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "c961c3f251af2cfc3ccd4b73bdfdd33ba61e42fa240a4fe08e7ce9ecee65bd83";
    }
    const { href, label } = t0;
    const { isActive } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$components$2f$custom$2f$layouts$2f$header$2d$wrapper$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useHeaderContext"])();
...
function Header(t0) {
    ...
    let t2;
    if ($[3] !== ctaButton.href || $[4] !== ctaButton.label) {
        t2 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "hidden md:block absolute right-4",
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(HeaderButton, {
                href: ctaButton.href,
...
//# sourceMappingURL=frontend_src_e3f62fcf._.js.map