...
function Navigation() {
    ...
    if ($[0] !== "4732d02a0090c2dffd85f505294edda121baec802275822cbe300bd43da6149c") {
        for(let $i = 0; $i < 5; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "4732d02a0090c2dffd85f505294edda121baec802275822cbe300bd43da6149c";
    }
...
function HeaderWrapper(t0) {
    ...
    if ($[0] !== "8d8d0c720f4cf7e931a01b091a4ff169609be78c3c4b96cde8a5ec712af3c8f9") {
        for(let $i = 0; $i < 10; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "8d8d0c720f4cf7e931a01b091a4ff169609be78c3c4b96cde8a5ec712af3c8f9";
    }
    const { children } = t0;
    ...
    const t3 = isScrolled || isHovered ? "bg-brand-pink text-brand-red" : "bg-black";
    let t4;
    if ($[3] !== t3) {
        t4 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("sticky top-0 z-50 flex flex-col items-center px-4 py-4 shadow-md transition-colors duration-300", t3);
        $[3] = t3;
        $[4] = t4;
    } else {
        t4 = $[4];
...
_s(HeaderWrapper, "LFLtgyh2cHtsA4CuQQx7H5qC/aY=");
_c = HeaderWrapper;
var _c;
...
//# sourceMappingURL=frontend_src_6b52164e._.js.map