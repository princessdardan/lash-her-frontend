...
function HeaderWrapper(t0) {
    ...
    const [scrollTimeout, setScrollTimeout] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    let t8;
    if ($[13] !== t3 || $[14] !== t7) {
        t8 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(HeaderContext.Provider, {
            value: t3,
            children: t7
        }, void 0, false, {
            fileName: "[project]/frontend/src/components/custom/layouts/header-wrapper.tsx",
...
function LashHerLogo(props) {
    ...
    if ($[0] !== "e324e496509a857338c2f6db37dfae3d913e5a03a7508826ead78ea53ff5d353") {
        for(let $i = 0; $i < 4; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "e324e496509a857338c2f6db37dfae3d913e5a03a7508826ead78ea53ff5d353";
    }
    let t0;
...
function Navigation() {
    ...
    if ($[0] !== "62ec837da30e8480833c4708d31730e088946fc9ceecf10319ced81b5e8d385f") {
        for(let $i = 0; $i < 6; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "62ec837da30e8480833c4708d31730e088946fc9ceecf10319ced81b5e8d385f";
    }
    const pathname = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"])();
...
const navLinks = [
    ...
    },
    {
        ...
        subLinks: [
            {
                href: "/beginner-private-training",
                label: "Beginner Private"
            },
            {
                href: "/advanced-private-training",
                label: "Advanced Private"
            },
            {
                href: "/lash-designer-academy",
                label: "Lash Designer Academy"
            }
        ]
    },
    {
...
function MobileNavigation(t0) {
    ...
    if ($[0] !== "0675be1db3dc788331560900e9997ec1bf326097fd77bdd34b2c3203ed760769") {
        for(let $i = 0; $i < 28; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "0675be1db3dc788331560900e9997ec1bf326097fd77bdd34b2c3203ed760769";
    }
    const { ctaButton } = t0;
    const pathname = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"])();
    const { isActive: isHeaderActive } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$components$2f$custom$2f$layouts$2f$header$2d$wrapper$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useHeaderContext"])();
    ...
    const [expandedItem, setExpandedItem] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    let t1;
    if ($[1] !== expandedItem) {
        t1 = ({
    ...
    const toggleExpanded = t1;
    const t2 = isHeaderActive ? "text-brand-red hover:bg-brand-red/10" : "text-brand-pink hover:bg-brand-pink/10";
    let t3;
    if ($[3] !== t2) {
        t3 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("p-2 rounded-md transition-colors", t2);
        $[3] = t2;
        $[4] = t3;
    } else {
        t3 = $[4];
    ...
    let t7;
    if ($[9] !== expandedItem || $[10] !== pathname || $[11] !== toggleExpanded) {
        t7 = navLinks.map({
            "MobileNavigation[navLinks.map()]": (link)=>{
                const isActive = pathname === link.href;
                const hasSubLinks = link.subLinks && link.subLinks.length > 0;
                const isSubLinkActive = link.subLinks?.some({
                    "MobileNavigation[navLinks.map() > (anonymous)()]": (subLink)=>pathname === subLink.href
                }["MobileNavigation[navLinks.map() > (anonymous)()]"]);
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                hasSubLinks && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    onClick: {
                                        "MobileNavigation[navLinks.map() > <button>.onClick]": ()=>toggleExpanded(link.id)
                                    }["MobileNavigation[navLinks.map() > <button>.onClick]"],
                        ...
                        hasSubLinks && isExpanded && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "ml-4 mt-1 flex flex-col gap-1",
                            children: link.subLinks.map({
                                "MobileNavigation[navLinks.map() > link.subLinks.map()]": (subLink_0)=>{
                                    const isSubActive = pathname === subLink_0.href;
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                        href: subLink_0.href,
                                        onClick: {
                                            "MobileNavigation[navLinks.map() > link.subLinks.map() > <Link>.onClick]": ()=>setOpen(false)
                                        }["MobileNavigation[navLinks.map() > link.subLinks.map() > <Link>.onClick]"],
                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("text-base font-light transition-colors py-2 px-4 rounded-md", isSubActive ? "font-semibold bg-brand-red/10 text-brand-red" : "text-gray-700 hover:bg-brand-pink/5 hover:text-brand-red"),
                                        children: subLink_0.label
                                    }, subLink_0.href, false, {
                                        fileName: "[project]/frontend/src/components/ui/mobile-navigation.tsx",
                                        lineNumber: 135,
                                        columnNumber: 24
                                    }, this);
                                }
                            }["MobileNavigation[navLinks.map() > link.subLinks.map()]"])
                        }, void 0, false, {
                            fileName: "[project]/frontend/src/components/ui/mobile-navigation.tsx",
                            lineNumber: 132,
                            columnNumber: 323
    ...
    let t8;
    if ($[13] !== t7) {
        t8 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
...
function HeaderButton(t0) {
    ...
    if ($[0] !== "ecaa079610f78f2af7c38cfa02bb9bbffe44ac64987da22a6f8e30c3d24f9e55") {
        for(let $i = 0; $i < 7; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "ecaa079610f78f2af7c38cfa02bb9bbffe44ac64987da22a6f8e30c3d24f9e55";
    }
    const { href, label } = t0;
    const { isActive } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$components$2f$custom$2f$layouts$2f$header$2d$wrapper$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useHeaderContext"])();
...
function Header(t0) {
    ...
    let t2;
    if ($[3] !== ctaButton) {
        t2 = ctaButton.map(_HeaderCtaButtonMap);
        $[3] = ctaButton;
        $[4] = t2;
    } else {
        t2 = $[4];
...
_c1 = Header;
function _HeaderCtaButtonMap(button, index) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(HeaderButton, {
        href: button.href,
        label: button.label
    }, index, false, {
        fileName: "[project]/frontend/src/components/custom/layouts/header.tsx",
...
//# sourceMappingURL=frontend_src_3c67ae0d._.js.map