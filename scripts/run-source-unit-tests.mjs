...
const DB_TEST_FILES = new Set([
  ...
  "src/lib/shipping/checkout-readiness-lock.db.test.ts",
  "src/lib/shipping/frozen-activation.db.test.ts",
  "src/lib/shipping/funding-reservations.db.test.ts",
  "src/lib/shipping/intake-location.db.test.ts",
  "src/lib/shipping/intake-location-immutability.db.test.ts",
  ...
  "src/lib/shipping/readiness-admin.db.test.ts",
  "src/lib/shipping/readiness-owner-evidence.db.test.ts",
